...
def color_print(text: str, *effects: str) -> None:
    ...
    :param effects: One or more effect we want. One of the constants we defined
...
color_print("Hello, Red Bold Underline", RED, BOLD, UNDERLINE)
# Test that color was reset
print("Color is reset")
